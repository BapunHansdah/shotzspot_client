...
// const DEFAULT_PROPERTY_ID = "500435769";
...
export default function AnalyticsDashboard() {
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 404) {
          ...
          throw new Error(
            `Failed to fetch data (${response.status}). Please try again.`
          );
        }
      }
  ...
  const handlePropertyIdChange = () => {
    if (customPropertyId.trim()) {
      ...
      localStorage.setItem("propertyId", customPropertyId.trim());
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="flex gap-3">
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          localStorage.setItem("propertyId", e.target.value)
                        }}
                    ...
                    <p className="text-slate-500 text-sm mt-2">
                      Enter your Google Analytics 4 property ID to start viewing
                      your data
                    </p>
                  </div>
        ...
        <div className="min-h-screen bg-[#1a1a2e] text-gray-100 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-slate-400">
              Fetching your data from Google Analytics...
            </p>
          </div>
        </div>
      </ProtectedRoute>
              ...
              {!showPropertyInput ? (
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" && handlePropertyIdChange()
                    }
                  />
                  <Button
                    onClick={handlePropertyIdChange}
                    size="sm"
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div
                          className={`p-3 rounded-xl bg-gradient-to-r ${metric.color} bg-opacity-20`}
                        >
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-white">
                          {formatDuration(
                            data?.overview.avgSessionDuration || "0"
                          )}
                        </p>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-white">
                          {formatNumber(data?.overview.conversions || 0)}
                        </p>
                      </div>
                    </div>
                  </CardContent>
                          ...
                          <Pie
                            data={data.devices.reduce((acc: any[], device) => {
                              const existing = acc.find(
                                (item) => item.name === device.deviceCategory
                              );
                              if (existing) {
                          ...
                          .map((source, index) => (
                            ...
                            >
                              ...
                              <div className="text-right">
                                <p className="text-white font-medium">
                                  {formatNumber(source.activeUsers)}
                                </p>
                      ...
                      <div className="space-y-4">
                        {data.geographic.slice(0, 5).map((location, index) => (
                          ...
                          >
                            ...
                            <div className="text-right">
                              <p className="text-white font-medium">
                                {formatNumber(location.activeUsers)}
                              </p>
                              <p className="text-slate-400 text-sm">
                        ...
                        >
                          <div className="flex items-center justify-between mb-3">
                            <h3 className="text-white font-medium capitalize">
                              {platform.sessionSource.replace(".com", "")}
                            </h3>
                            <Badge
                              variant="outline"
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              ...
                              <span className="text-white font-medium">
                                {formatNumber(platform.activeUsers)}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-slate-400 text-sm">
